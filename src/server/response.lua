-- written by EvandroLG & pegasus contributors w/ minor edits
...
local DEFAULT_ERROR_MESSAGE =
    "<!DOCTYPE HTML><html><head><meta http-equiv='Content-Type' content='text/html;charset=utf-8'><title>Uh oh!</title></head><body><h1>Uh oh!</h1><p>Error code: {{ STATUS_CODE }}</p><p>Message: {{ STATUS_TEXT }}</p></body></html>"
...
function Response.new(client, writeHandler)
    ...
    return setmetatable(newObj, Response)
end
...
function Response:writeData(data, contentType)
